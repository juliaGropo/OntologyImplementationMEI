 ...
 * Source Class: AtividadeCondicaoProduto <br>
 * @version generated on Sat Sep 15 16:28:32 BRT 2018 by Julia
 */

public interface AtividadeCondicaoProduto extends AtividadeCondicao {

    /* ***************************************************
     * Property http://www.semanticweb.org/gabriel/ontologies/2017/8/mei#condicaoProdutoSatisfeitaPor
     */
     
    /**
     * Gets all property values for the condicaoProdutoSatisfeitaPor property.<p>
     * 
     * @returns a collection of values for the condicaoProdutoSatisfeitaPor property.
     */
    Collection<? extends AtividadeProduto> getCondicaoProdutoSatisfeitaPor();

    /**
     * Checks if the class has a condicaoProdutoSatisfeitaPor property value.<p>
     * 
     * @return true if there is a condicaoProdutoSatisfeitaPor property value.
     */
    boolean hasCondicaoProdutoSatisfeitaPor();

    /**
     * Adds a condicaoProdutoSatisfeitaPor property value.<p>
     * 
     * @param newCondicaoProdutoSatisfeitaPor the condicaoProdutoSatisfeitaPor property value to be added
     */
    void addCondicaoProdutoSatisfeitaPor(AtividadeProduto newCondicaoProdutoSatisfeitaPor);

    /**
     * Removes a condicaoProdutoSatisfeitaPor property value.<p>
     * 
     * @param oldCondicaoProdutoSatisfeitaPor the condicaoProdutoSatisfeitaPor property value to be removed.
     */
    void removeCondicaoProdutoSatisfeitaPor(AtividadeProduto oldCondicaoProdutoSatisfeitaPor);
