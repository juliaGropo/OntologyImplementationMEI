 ...
 * Source Class: AtividadeRequisitoProdutoDefinitivo <br>
 * @version generated on Sat Sep 15 16:28:33 BRT 2018 by Julia
 */

public interface AtividadeRequisitoProdutoDefinitivo extends AtividadeRequisitoDefinitivo {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/gabriel/ontologies/2017/8/mei#requisitoProdutoDefinitivoTidoPor
     */
     
    /**
     * Gets all property values for the requisitoProdutoDefinitivoTidoPor property.<p>
     * 
     * @returns a collection of values for the requisitoProdutoDefinitivoTidoPor property.
     */
    Collection<? extends AtividadeCondicaoProduto> getRequisitoProdutoDefinitivoTidoPor();

    /**
     * Checks if the class has a requisitoProdutoDefinitivoTidoPor property value.<p>
     * 
     * @return true if there is a requisitoProdutoDefinitivoTidoPor property value.
     */
    boolean hasRequisitoProdutoDefinitivoTidoPor();

    /**
     * Adds a requisitoProdutoDefinitivoTidoPor property value.<p>
     * 
     * @param newRequisitoProdutoDefinitivoTidoPor the requisitoProdutoDefinitivoTidoPor property value to be added
     */
    void addRequisitoProdutoDefinitivoTidoPor(AtividadeCondicaoProduto newRequisitoProdutoDefinitivoTidoPor);

    /**
     * Removes a requisitoProdutoDefinitivoTidoPor property value.<p>
     * 
     * @param oldRequisitoProdutoDefinitivoTidoPor the requisitoProdutoDefinitivoTidoPor property value to be removed.
     */
    void removeRequisitoProdutoDefinitivoTidoPor(AtividadeCondicaoProduto oldRequisitoProdutoDefinitivoTidoPor);
