 ...
 * Source Class: DefaultAtividadeCondicaoProduto <br>
 * @version generated on Sat Sep 15 16:28:32 BRT 2018 by Julia
 */
public class DefaultAtividadeCondicaoProduto extends WrappedIndividualImpl implements AtividadeCondicaoProduto {

    public DefaultAtividadeCondicaoProduto(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends AtividadeProduto> getCondicaoProdutoSatisfeitaPor() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_CONDICAOPRODUTOSATISFEITAPOR,
                                               DefaultAtividadeProduto.class);
    }

    public boolean hasCondicaoProdutoSatisfeitaPor() {
	   return !getCondicaoProdutoSatisfeitaPor().isEmpty();
    }

    public void addCondicaoProdutoSatisfeitaPor(AtividadeProduto newCondicaoProdutoSatisfeitaPor) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_CONDICAOPRODUTOSATISFEITAPOR,
                                       newCondicaoProdutoSatisfeitaPor);
    }

    public void removeCondicaoProdutoSatisfeitaPor(AtividadeProduto oldCondicaoProdutoSatisfeitaPor) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_CONDICAOPRODUTOSATISFEITAPOR,
                                          oldCondicaoProdutoSatisfeitaPor);
    }
