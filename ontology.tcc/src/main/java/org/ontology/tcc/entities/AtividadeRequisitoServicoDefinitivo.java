 ...
 * Source Class: AtividadeRequisitoServicoDefinitivo <br>
 * @version generated on Sat Sep 15 16:28:34 BRT 2018 by Julia
 */

public interface AtividadeRequisitoServicoDefinitivo extends AtividadeRequisitoDefinitivo {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/gabriel/ontologies/2017/8/mei#requisitoServicoDefinitivoTidoPor
     */
     
    /**
     * Gets all property values for the requisitoServicoDefinitivoTidoPor property.<p>
     * 
     * @returns a collection of values for the requisitoServicoDefinitivoTidoPor property.
     */
    Collection<? extends AtividadeCondicaoServico> getRequisitoServicoDefinitivoTidoPor();

    /**
     * Checks if the class has a requisitoServicoDefinitivoTidoPor property value.<p>
     * 
     * @return true if there is a requisitoServicoDefinitivoTidoPor property value.
     */
    boolean hasRequisitoServicoDefinitivoTidoPor();

    /**
     * Adds a requisitoServicoDefinitivoTidoPor property value.<p>
     * 
     * @param newRequisitoServicoDefinitivoTidoPor the requisitoServicoDefinitivoTidoPor property value to be added
     */
    void addRequisitoServicoDefinitivoTidoPor(AtividadeCondicaoServico newRequisitoServicoDefinitivoTidoPor);

    /**
     * Removes a requisitoServicoDefinitivoTidoPor property value.<p>
     * 
     * @param oldRequisitoServicoDefinitivoTidoPor the requisitoServicoDefinitivoTidoPor property value to be removed.
     */
    void removeRequisitoServicoDefinitivoTidoPor(AtividadeCondicaoServico oldRequisitoServicoDefinitivoTidoPor);
