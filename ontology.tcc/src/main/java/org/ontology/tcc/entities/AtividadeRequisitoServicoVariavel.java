 ...
 * Source Class: AtividadeRequisitoServicoVariavel <br>
 * @version generated on Sat Sep 15 16:28:34 BRT 2018 by Julia
 */

public interface AtividadeRequisitoServicoVariavel extends AtividadeRequisitoVariavel {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/gabriel/ontologies/2017/8/mei#requisitoServicoVariavelTidoPor
     */
     
    /**
     * Gets all property values for the requisitoServicoVariavelTidoPor property.<p>
     * 
     * @returns a collection of values for the requisitoServicoVariavelTidoPor property.
     */
    Collection<? extends AtividadeCondicaoServico> getRequisitoServicoVariavelTidoPor();

    /**
     * Checks if the class has a requisitoServicoVariavelTidoPor property value.<p>
     * 
     * @return true if there is a requisitoServicoVariavelTidoPor property value.
     */
    boolean hasRequisitoServicoVariavelTidoPor();

    /**
     * Adds a requisitoServicoVariavelTidoPor property value.<p>
     * 
     * @param newRequisitoServicoVariavelTidoPor the requisitoServicoVariavelTidoPor property value to be added
     */
    void addRequisitoServicoVariavelTidoPor(AtividadeCondicaoServico newRequisitoServicoVariavelTidoPor);

    /**
     * Removes a requisitoServicoVariavelTidoPor property value.<p>
     * 
     * @param oldRequisitoServicoVariavelTidoPor the requisitoServicoVariavelTidoPor property value to be removed.
     */
    void removeRequisitoServicoVariavelTidoPor(AtividadeCondicaoServico oldRequisitoServicoVariavelTidoPor);
