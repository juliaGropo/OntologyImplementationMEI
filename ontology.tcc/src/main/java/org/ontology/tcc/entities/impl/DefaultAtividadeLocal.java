 ...
 * Source Class: DefaultAtividadeLocal <br>
 * @version generated on Sat Sep 15 16:28:33 BRT 2018 by Julia
 */
public class DefaultAtividadeLocal extends WrappedIndividualImpl implements AtividadeLocal {

    public DefaultAtividadeLocal(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends AtividadeCondicaoLocal> getSatisfazCondicaoLocal() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_SATISFAZCONDICAOLOCAL,
                                               DefaultAtividadeCondicaoLocal.class);
    }

    public boolean hasSatisfazCondicaoLocal() {
	   return !getSatisfazCondicaoLocal().isEmpty();
    }

    public void addSatisfazCondicaoLocal(AtividadeCondicaoLocal newSatisfazCondicaoLocal) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_SATISFAZCONDICAOLOCAL,
                                       newSatisfazCondicaoLocal);
    }

    public void removeSatisfazCondicaoLocal(AtividadeCondicaoLocal oldSatisfazCondicaoLocal) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_SATISFAZCONDICAOLOCAL,
                                          oldSatisfazCondicaoLocal);
    }
