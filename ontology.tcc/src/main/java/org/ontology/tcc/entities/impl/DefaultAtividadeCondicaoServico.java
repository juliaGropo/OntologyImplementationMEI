 ...
 * Source Class: DefaultAtividadeCondicaoServico <br>
 * @version generated on Sat Sep 15 16:28:32 BRT 2018 by Julia
 */
public class DefaultAtividadeCondicaoServico extends WrappedIndividualImpl implements AtividadeCondicaoServico {

    public DefaultAtividadeCondicaoServico(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends AtividadeServico> getCondicaoServicoSatisfeitaPor() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_CONDICAOSERVICOSATISFEITAPOR,
                                               DefaultAtividadeServico.class);
    }

    public boolean hasCondicaoServicoSatisfeitaPor() {
	   return !getCondicaoServicoSatisfeitaPor().isEmpty();
    }

    public void addCondicaoServicoSatisfeitaPor(AtividadeServico newCondicaoServicoSatisfeitaPor) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_CONDICAOSERVICOSATISFEITAPOR,
                                       newCondicaoServicoSatisfeitaPor);
    }

    public void removeCondicaoServicoSatisfeitaPor(AtividadeServico oldCondicaoServicoSatisfeitaPor) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_CONDICAOSERVICOSATISFEITAPOR,
                                          oldCondicaoServicoSatisfeitaPor);
    }
