 ...
 * Source Class: AtividadeRequisitoProdutoVariavel <br>
 * @version generated on Sat Sep 15 16:28:34 BRT 2018 by Julia
 */

public interface AtividadeRequisitoProdutoVariavel extends AtividadeRequisitoVariavel {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/gabriel/ontologies/2017/8/mei#requisitoProdutoVariavelTidoPor
     */
     
    /**
     * Gets all property values for the requisitoProdutoVariavelTidoPor property.<p>
     * 
     * @returns a collection of values for the requisitoProdutoVariavelTidoPor property.
     */
    Collection<? extends AtividadeCondicaoProduto> getRequisitoProdutoVariavelTidoPor();

    /**
     * Checks if the class has a requisitoProdutoVariavelTidoPor property value.<p>
     * 
     * @return true if there is a requisitoProdutoVariavelTidoPor property value.
     */
    boolean hasRequisitoProdutoVariavelTidoPor();

    /**
     * Adds a requisitoProdutoVariavelTidoPor property value.<p>
     * 
     * @param newRequisitoProdutoVariavelTidoPor the requisitoProdutoVariavelTidoPor property value to be added
     */
    void addRequisitoProdutoVariavelTidoPor(AtividadeCondicaoProduto newRequisitoProdutoVariavelTidoPor);

    /**
     * Removes a requisitoProdutoVariavelTidoPor property value.<p>
     * 
     * @param oldRequisitoProdutoVariavelTidoPor the requisitoProdutoVariavelTidoPor property value to be removed.
     */
    void removeRequisitoProdutoVariavelTidoPor(AtividadeCondicaoProduto oldRequisitoProdutoVariavelTidoPor);
