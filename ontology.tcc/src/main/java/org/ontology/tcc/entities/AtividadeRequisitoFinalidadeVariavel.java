 ...
 * Source Class: AtividadeRequisitoFinalidadeVariavel <br>
 * @version generated on Sat Sep 15 16:28:33 BRT 2018 by Julia
 */

public interface AtividadeRequisitoFinalidadeVariavel extends AtividadeRequisitoVariavel {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/gabriel/ontologies/2017/8/mei#requisitoFinalidadeVariavelTidoPor
     */
     
    /**
     * Gets all property values for the requisitoFinalidadeVariavelTidoPor property.<p>
     * 
     * @returns a collection of values for the requisitoFinalidadeVariavelTidoPor property.
     */
    Collection<? extends AtividadeCondicaoFinalidade> getRequisitoFinalidadeVariavelTidoPor();

    /**
     * Checks if the class has a requisitoFinalidadeVariavelTidoPor property value.<p>
     * 
     * @return true if there is a requisitoFinalidadeVariavelTidoPor property value.
     */
    boolean hasRequisitoFinalidadeVariavelTidoPor();

    /**
     * Adds a requisitoFinalidadeVariavelTidoPor property value.<p>
     * 
     * @param newRequisitoFinalidadeVariavelTidoPor the requisitoFinalidadeVariavelTidoPor property value to be added
     */
    void addRequisitoFinalidadeVariavelTidoPor(AtividadeCondicaoFinalidade newRequisitoFinalidadeVariavelTidoPor);

    /**
     * Removes a requisitoFinalidadeVariavelTidoPor property value.<p>
     * 
     * @param oldRequisitoFinalidadeVariavelTidoPor the requisitoFinalidadeVariavelTidoPor property value to be removed.
     */
    void removeRequisitoFinalidadeVariavelTidoPor(AtividadeCondicaoFinalidade oldRequisitoFinalidadeVariavelTidoPor);
