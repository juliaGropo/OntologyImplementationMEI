 ...
 * Source Class: DefaultAtividadeRequisitoLocalDefinitivo <br>
 * @version generated on Sat Sep 15 16:28:33 BRT 2018 by Julia
 */
public class DefaultAtividadeRequisitoLocalDefinitivo extends WrappedIndividualImpl implements AtividadeRequisitoLocalDefinitivo {

    public DefaultAtividadeRequisitoLocalDefinitivo(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends AtividadeCondicaoLocal> getRequisitoLocalDefinitivoTidoPor() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_REQUISITOLOCALDEFINITIVOTIDOPOR,
                                               DefaultAtividadeCondicaoLocal.class);
    }

    public boolean hasRequisitoLocalDefinitivoTidoPor() {
	   return !getRequisitoLocalDefinitivoTidoPor().isEmpty();
    }

    public void addRequisitoLocalDefinitivoTidoPor(AtividadeCondicaoLocal newRequisitoLocalDefinitivoTidoPor) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_REQUISITOLOCALDEFINITIVOTIDOPOR,
                                       newRequisitoLocalDefinitivoTidoPor);
    }

    public void removeRequisitoLocalDefinitivoTidoPor(AtividadeCondicaoLocal oldRequisitoLocalDefinitivoTidoPor) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_REQUISITOLOCALDEFINITIVOTIDOPOR,
                                          oldRequisitoLocalDefinitivoTidoPor);
    }
