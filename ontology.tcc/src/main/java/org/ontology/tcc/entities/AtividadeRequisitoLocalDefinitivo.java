 ...
 * Source Class: AtividadeRequisitoLocalDefinitivo <br>
 * @version generated on Sat Sep 15 16:28:33 BRT 2018 by Julia
 */

public interface AtividadeRequisitoLocalDefinitivo extends AtividadeRequisitoDefinitivo {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/gabriel/ontologies/2017/8/mei#requisitoLocalDefinitivoTidoPor
     */
     
    /**
     * Gets all property values for the requisitoLocalDefinitivoTidoPor property.<p>
     * 
     * @returns a collection of values for the requisitoLocalDefinitivoTidoPor property.
     */
    Collection<? extends AtividadeCondicaoLocal> getRequisitoLocalDefinitivoTidoPor();

    /**
     * Checks if the class has a requisitoLocalDefinitivoTidoPor property value.<p>
     * 
     * @return true if there is a requisitoLocalDefinitivoTidoPor property value.
     */
    boolean hasRequisitoLocalDefinitivoTidoPor();

    /**
     * Adds a requisitoLocalDefinitivoTidoPor property value.<p>
     * 
     * @param newRequisitoLocalDefinitivoTidoPor the requisitoLocalDefinitivoTidoPor property value to be added
     */
    void addRequisitoLocalDefinitivoTidoPor(AtividadeCondicaoLocal newRequisitoLocalDefinitivoTidoPor);

    /**
     * Removes a requisitoLocalDefinitivoTidoPor property value.<p>
     * 
     * @param oldRequisitoLocalDefinitivoTidoPor the requisitoLocalDefinitivoTidoPor property value to be removed.
     */
    void removeRequisitoLocalDefinitivoTidoPor(AtividadeCondicaoLocal oldRequisitoLocalDefinitivoTidoPor);
