 ...
 * Source Class: DefaultAtividadeRequisitoLocalVariavel <br>
 * @version generated on Sat Sep 15 16:28:33 BRT 2018 by Julia
 */
public class DefaultAtividadeRequisitoLocalVariavel extends WrappedIndividualImpl implements AtividadeRequisitoLocalVariavel {

    public DefaultAtividadeRequisitoLocalVariavel(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends AtividadeCondicaoLocal> getRequisitoLocalVariavelTidoPor() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_REQUISITOLOCALVARIAVELTIDOPOR,
                                               DefaultAtividadeCondicaoLocal.class);
    }

    public boolean hasRequisitoLocalVariavelTidoPor() {
	   return !getRequisitoLocalVariavelTidoPor().isEmpty();
    }

    public void addRequisitoLocalVariavelTidoPor(AtividadeCondicaoLocal newRequisitoLocalVariavelTidoPor) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_REQUISITOLOCALVARIAVELTIDOPOR,
                                       newRequisitoLocalVariavelTidoPor);
    }

    public void removeRequisitoLocalVariavelTidoPor(AtividadeCondicaoLocal oldRequisitoLocalVariavelTidoPor) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_REQUISITOLOCALVARIAVELTIDOPOR,
                                          oldRequisitoLocalVariavelTidoPor);
    }
