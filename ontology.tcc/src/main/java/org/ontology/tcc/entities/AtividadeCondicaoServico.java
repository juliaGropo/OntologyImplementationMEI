 ...
 * Source Class: AtividadeCondicaoServico <br>
 * @version generated on Sat Sep 15 16:28:32 BRT 2018 by Julia
 */

public interface AtividadeCondicaoServico extends AtividadeCondicao {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/gabriel/ontologies/2017/8/mei#condicaoServicoSatisfeitaPor
     */
     
    /**
     * Gets all property values for the condicaoServicoSatisfeitaPor property.<p>
     * 
     * @returns a collection of values for the condicaoServicoSatisfeitaPor property.
     */
    Collection<? extends AtividadeServico> getCondicaoServicoSatisfeitaPor();

    /**
     * Checks if the class has a condicaoServicoSatisfeitaPor property value.<p>
     * 
     * @return true if there is a condicaoServicoSatisfeitaPor property value.
     */
    boolean hasCondicaoServicoSatisfeitaPor();

    /**
     * Adds a condicaoServicoSatisfeitaPor property value.<p>
     * 
     * @param newCondicaoServicoSatisfeitaPor the condicaoServicoSatisfeitaPor property value to be added
     */
    void addCondicaoServicoSatisfeitaPor(AtividadeServico newCondicaoServicoSatisfeitaPor);

    /**
     * Removes a condicaoServicoSatisfeitaPor property value.<p>
     * 
     * @param oldCondicaoServicoSatisfeitaPor the condicaoServicoSatisfeitaPor property value to be removed.
     */
    void removeCondicaoServicoSatisfeitaPor(AtividadeServico oldCondicaoServicoSatisfeitaPor);
