 ...
 * Source Class: DefaultAtividadeCondicaoLocal <br>
 * @version generated on Sat Sep 15 16:28:32 BRT 2018 by Julia
 */
public class DefaultAtividadeCondicaoLocal extends WrappedIndividualImpl implements AtividadeCondicaoLocal {

    public DefaultAtividadeCondicaoLocal(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends AtividadeLocal> getCondicaoLocalSatisfeitaPor() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_CONDICAOLOCALSATISFEITAPOR,
                                               DefaultAtividadeLocal.class);
    }

    public boolean hasCondicaoLocalSatisfeitaPor() {
	   return !getCondicaoLocalSatisfeitaPor().isEmpty();
    }

    public void addCondicaoLocalSatisfeitaPor(AtividadeLocal newCondicaoLocalSatisfeitaPor) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_CONDICAOLOCALSATISFEITAPOR,
                                       newCondicaoLocalSatisfeitaPor);
    }

    public void removeCondicaoLocalSatisfeitaPor(AtividadeLocal oldCondicaoLocalSatisfeitaPor) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_CONDICAOLOCALSATISFEITAPOR,
                                          oldCondicaoLocalSatisfeitaPor);
    }
