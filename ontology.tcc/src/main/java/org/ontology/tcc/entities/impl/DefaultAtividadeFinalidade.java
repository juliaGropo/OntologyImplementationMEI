 ...
 * Source Class: DefaultAtividadeFinalidade <br>
 * @version generated on Sat Sep 15 16:28:32 BRT 2018 by Julia
 */
public class DefaultAtividadeFinalidade extends WrappedIndividualImpl implements AtividadeFinalidade {

    public DefaultAtividadeFinalidade(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends AtividadeCondicaoFinalidade> getSatisfazCondicaoFinalidade() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_SATISFAZCONDICAOFINALIDADE,
                                               DefaultAtividadeCondicaoFinalidade.class);
    }

    public boolean hasSatisfazCondicaoFinalidade() {
	   return !getSatisfazCondicaoFinalidade().isEmpty();
    }

    public void addSatisfazCondicaoFinalidade(AtividadeCondicaoFinalidade newSatisfazCondicaoFinalidade) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_SATISFAZCONDICAOFINALIDADE,
                                       newSatisfazCondicaoFinalidade);
    }

    public void removeSatisfazCondicaoFinalidade(AtividadeCondicaoFinalidade oldSatisfazCondicaoFinalidade) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_SATISFAZCONDICAOFINALIDADE,
                                          oldSatisfazCondicaoFinalidade);
    }
