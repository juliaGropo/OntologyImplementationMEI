 ...
 * Source Class: DefaultAtividadeRequisitoProdutoDefinitivo <br>
 * @version generated on Sat Sep 15 16:28:33 BRT 2018 by Julia
 */
public class DefaultAtividadeRequisitoProdutoDefinitivo extends WrappedIndividualImpl implements AtividadeRequisitoProdutoDefinitivo {

    public DefaultAtividadeRequisitoProdutoDefinitivo(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends AtividadeCondicaoProduto> getRequisitoProdutoDefinitivoTidoPor() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_REQUISITOPRODUTODEFINITIVOTIDOPOR,
                                               DefaultAtividadeCondicaoProduto.class);
    }

    public boolean hasRequisitoProdutoDefinitivoTidoPor() {
	   return !getRequisitoProdutoDefinitivoTidoPor().isEmpty();
    }

    public void addRequisitoProdutoDefinitivoTidoPor(AtividadeCondicaoProduto newRequisitoProdutoDefinitivoTidoPor) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_REQUISITOPRODUTODEFINITIVOTIDOPOR,
                                       newRequisitoProdutoDefinitivoTidoPor);
    }

    public void removeRequisitoProdutoDefinitivoTidoPor(AtividadeCondicaoProduto oldRequisitoProdutoDefinitivoTidoPor) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_REQUISITOPRODUTODEFINITIVOTIDOPOR,
                                          oldRequisitoProdutoDefinitivoTidoPor);
    }
