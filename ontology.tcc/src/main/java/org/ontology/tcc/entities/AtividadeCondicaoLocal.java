 ...
 * Source Class: AtividadeCondicaoLocal <br>
 * @version generated on Sat Sep 15 16:28:32 BRT 2018 by Julia
 */

public interface AtividadeCondicaoLocal extends AtividadeCondicao {

    /* ***************************************************
     * Property http://www.semanticweb.org/gabriel/ontologies/2017/8/mei#condicaoLocalSatisfeitaPor
     */
     
    /**
     * Gets all property values for the condicaoLocalSatisfeitaPor property.<p>
     * 
     * @returns a collection of values for the condicaoLocalSatisfeitaPor property.
     */
    Collection<? extends AtividadeLocal> getCondicaoLocalSatisfeitaPor();

    /**
     * Checks if the class has a condicaoLocalSatisfeitaPor property value.<p>
     * 
     * @return true if there is a condicaoLocalSatisfeitaPor property value.
     */
    boolean hasCondicaoLocalSatisfeitaPor();

    /**
     * Adds a condicaoLocalSatisfeitaPor property value.<p>
     * 
     * @param newCondicaoLocalSatisfeitaPor the condicaoLocalSatisfeitaPor property value to be added
     */
    void addCondicaoLocalSatisfeitaPor(AtividadeLocal newCondicaoLocalSatisfeitaPor);

    /**
     * Removes a condicaoLocalSatisfeitaPor property value.<p>
     * 
     * @param oldCondicaoLocalSatisfeitaPor the condicaoLocalSatisfeitaPor property value to be removed.
     */
    void removeCondicaoLocalSatisfeitaPor(AtividadeLocal oldCondicaoLocalSatisfeitaPor);
