 ...
 * Source Class: DefaultAtividadeServico <br>
 * @version generated on Sat Sep 15 16:28:34 BRT 2018 by Julia
 */
public class DefaultAtividadeServico extends WrappedIndividualImpl implements AtividadeServico {

    public DefaultAtividadeServico(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends AtividadeCondicaoServico> getSatisfazCondicaoServico() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_SATISFAZCONDICAOSERVICO,
                                               DefaultAtividadeCondicaoServico.class);
    }

    public boolean hasSatisfazCondicaoServico() {
	   return !getSatisfazCondicaoServico().isEmpty();
    }

    public void addSatisfazCondicaoServico(AtividadeCondicaoServico newSatisfazCondicaoServico) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_SATISFAZCONDICAOSERVICO,
                                       newSatisfazCondicaoServico);
    }

    public void removeSatisfazCondicaoServico(AtividadeCondicaoServico oldSatisfazCondicaoServico) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_SATISFAZCONDICAOSERVICO,
                                          oldSatisfazCondicaoServico);
    }
